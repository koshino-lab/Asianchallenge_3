...
abstract class Styles {
  ...
  static const Color primaryColor = Color(0xFFAE4504);

  static const Color accentColor = Color(0xFFAE4504);
  static const Color myButtonColor = Color.fromARGB(255, 253, 234, 234);

  static const Color pageBackground = accentColor;
  static const Color pageBackgroundDark = Color(0xFF2E1913);
  static const Color appBarTitleColor = contentsColor;
  static const Color appBarBackgroundColor = Color.fromARGB(255, 178, 220, 135);
  static const Color commonTextColor = Color(0xFF2E1813);
  static const Color secondaryTextColor = Color(0xFF2E1813);
  ...
  static AppBarTheme appBarTheme = const AppBarTheme(
    ...
    iconTheme: IconThemeData(color: Styles.appBarTitleColor),
  );
}
